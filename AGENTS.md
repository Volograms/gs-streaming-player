...
- Use parallel agents for independent, read-heavy work such as repository exploration, review, test analysis, and log investigation. There is a bug and it is not efficient. 
